<div 
    ...
    class="flex flex-col w-1/2 max-w-xs gap-1 my-8" 
...
>
    ...
    <div class="relative">
        ...
        <!-- trigger button  -->
        <button type="button" role="combobox" class="inline-flex items-center justify-center w-full gap-2 px-4 py-2 text-sm font-medium tracking-wide capitalize transition border rounded-sm shadow-sm whitespace-nowrap dark:shadow-neutral-600 border-neutral-300 bg-neutral-50 text-neutral-900 hover:opacity-75 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 dark:focus-visible:outline-white" aria-haspopup="listbox" aria-controls="industriesList" x-on:click="isOpen = ! isOpen" x-on:keydown.down.prevent="openedWithKeyboard = true" x-on:keydown.enter.prevent="openedWithKeyboard = true" x-on:keydown.space.prevent="openedWithKeyboard = true" x-bind:aria-label="selectedOption ? selectedOption.value : 'Please Select'" x-bind:aria-expanded="isOpen || openedWithKeyboard">
