<nav 
    ...
    class="flex items-center justify-between px-6 py-4 border-b bg-zinc-100 border-neutral-300 dark:border-neutral-700 dark:bg-zinc-800" aria-label="penguin ui menu"
>
	<!-- Brand Logo -->
